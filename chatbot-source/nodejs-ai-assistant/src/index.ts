...
app.post("/start-ai-agent", async (req, res) => {
  ...
  try {
    ...
    // Provide more specific error message for quota errors
    if (isQuotaError(error)) {
      res.status(402).json({
        error: "Gemini API quota exceeded",
        reason: "Please check your Google Cloud billing and quota limits. Visit https://console.cloud.google.com/apis/api/generativelanguage.googleapis.com/quotas to manage your quotas.",
